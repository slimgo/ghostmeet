...
- Системный распознаватель (`SpeechAnalyzer`, macOS 26) на русском теряет термины и не ставит
  знаков препинания, поэтому по умолчанию там остаётся Whisper; на английском они равны по тексту,
  а системный втрое быстрее. Выбрать можно любой, но системному язык звонка нужно назвать заранее —

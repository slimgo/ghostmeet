...
- **Кнопка «Сохранить диалог» под транскриптом** — весь разговор одной лентой: обе стороны и ответы модели по времени, с шапкой о звонке. Помеченные протечки вычищены, но их число названо в шапке — иначе «протечек не было» не отличить от «фильтр их не увидел». Пишет только через панель сохранения: до этой возможности приложение не писало на диск ничего, и обещание остаётся буквальным
